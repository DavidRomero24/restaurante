...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Code+Pro|Righteous" rel="stylesheet">
  <style>
    :root {
    ...
    * {
    ...
    .hand-left .hand-part.part-bottom {
      top: -10px;
      left: 0;
      height: 20px;
      border-radius: 7px;
    ...
    .hand-left .hand-part.part-middle {
      left: 26px;
      top: -10px;
      transform: rotate(-40deg);
    }

    .hand-left .hand-part.part-top {
      left: 45px;
      top: -32px;
      transform: rotate(-60deg);
    }

    .hand-right .hand-part.part-bottom {
      left: auto;
      right: 0;
    }

    .hand-right .hand-part.part-middle {
      left: auto;
      right: 26px;
      transform: rotate(40deg);
    }

    .hand-right .hand-part.part-top {
      left: auto;
      right: 45px;
      transform: rotate(60deg);
    }
