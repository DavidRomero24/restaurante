          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{route('products.index')}}" class="nav-link">
                <svg id="Layer_1_1_" style="enable-background:new 0 0 64 64; width: 12%; height:12%; margin-right: 6px;" version="1.1" viewBox="0 0 64 64" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <g>
                    <g>
            ...
            <li class="nav-item">
              <a href="test-403" class="nav-link">
            ...
            <li class="nav-item">
              <a href="test-419" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" style="width: 10%; height:10%; margin-left: 4px; margin-right: 6px;" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                </svg>
